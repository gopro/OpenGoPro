...
private abstract class IntEnumSerializer<T : IntEnum>(
    ...
    override fun deserialize(decoder: Decoder): T =
        companion.fromInt(decoder.decodeInt())
...
private object WebcamErrorIntEnumSerializer :
    IntEnumSerializer<WebcamError>(WebcamError::class, WebcamError.Companion)

private object WebcamStatusIntEnumSerializer :
    IntEnumSerializer<WebcamStatus>(WebcamStatus::class, WebcamStatus.Companion)
 ...
 *
 * Furthermore, the pbandk protobuf library provides a json encoder however this nonconfigurably writes
 * the enum values using their string name. Our API however requires the enums, in the HTTP
...
private abstract class EnumProtoSerializerByValue<T : pbandk.Message.Enum>(
    ...
    override fun deserialize(decoder: Decoder): T =
        enum.fromValue(decoder.decodeString().toInt())
...
private object EnumCohnNetworkStateSerializerByValue :
    EnumProtoSerializerByValue<EnumCOHNNetworkState>(
        EnumCOHNNetworkState::class,
        EnumCOHNNetworkState.Companion
    )

private object EnumPresetGroupIconSerializerByValue :
    EnumProtoSerializerByValue<EnumPresetGroupIcon>(
        EnumPresetGroupIcon::class,
        EnumPresetGroupIcon.Companion
    )
...
private abstract class EnumProtoSerializerByName<T : pbandk.Message.Enum>(
    ...
    override fun deserialize(decoder: Decoder): T =
        enum.fromName(decoder.decodeString())
