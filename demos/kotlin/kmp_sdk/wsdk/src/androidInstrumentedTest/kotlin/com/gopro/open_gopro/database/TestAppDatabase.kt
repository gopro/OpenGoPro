...
class TestAppDatabase {
    ...
    fun testHttpsCredentialsDao() = runTest {
        // Add an retrieve one entry
        val credentialsEntry1 = HttpsCredentialsDbEntry(
            serialId = "1234",
            username = "username",
            password = "password"
        )
        ...
        // Overwrite and get new entry
        val credentialsEntry2 = HttpsCredentialsDbEntry(
            serialId = "1234",
            username = "username2",
            password = "password2"
        )
        ...
        val credentialsEntry3 = HttpsCredentialsDbEntry(
            serialId = "5678",
            username = "username2",
            password = "password2"
        )
    ...
    fun testCertificatesDao() = runTest {
        ...
        val certificateEntry1 = CertificatesDbEntry(
            serialId = "1234",
            certificates = jsonDefault.encodeToString(certs)
        )
