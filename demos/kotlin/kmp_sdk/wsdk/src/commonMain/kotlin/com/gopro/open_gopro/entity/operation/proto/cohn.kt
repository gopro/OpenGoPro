...
sealed class EnumCOHNNetworkState(override val value: Int, override val name: String? = null) : pbandk.Message.Enum {
    ...
    internal companion object : pbandk.Message.Enum.Companion<com.gopro.open_gopro.operations.EnumCOHNNetworkState> {
        internal val values: List<com.gopro.open_gopro.operations.EnumCOHNNetworkState> by lazy { listOf(COHN_STATE_INIT, COHN_STATE_ERROR, COHN_STATE_EXIT, COHN_STATE_IDLE, COHN_STATE_NETWORK_CONNECTED, COHN_STATE_NETWORK_DISCONNECTED, COHN_STATE_CONNECTING_TO_NETWORK, COHN_STATE_INVALID) }
        override fun fromValue(value: Int): com.gopro.open_gopro.operations.EnumCOHNNetworkState = values.firstOrNull { it.value == value } ?: UNRECOGNIZED(value)
        override fun fromName(name: String): com.gopro.open_gopro.operations.EnumCOHNNetworkState = values.firstOrNull { it.name == name } ?: throw IllegalArgumentException("No EnumCOHNNetworkState with name: $name")
    }
}
...
internal data class RequestGetCOHNStatus(
    ...
    override operator fun plus(other: pbandk.Message?): com.gopro.open_gopro.operations.RequestGetCOHNStatus = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<com.gopro.open_gopro.operations.RequestGetCOHNStatus> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    internal companion object : pbandk.Message.Companion<com.gopro.open_gopro.operations.RequestGetCOHNStatus> {
        internal val defaultInstance: com.gopro.open_gopro.operations.RequestGetCOHNStatus by lazy { com.gopro.open_gopro.operations.RequestGetCOHNStatus() }
        override fun decodeWith(u: pbandk.MessageDecoder): com.gopro.open_gopro.operations.RequestGetCOHNStatus = com.gopro.open_gopro.operations.RequestGetCOHNStatus.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<com.gopro.open_gopro.operations.RequestGetCOHNStatus> = pbandk.MessageDescriptor(
            ...
            fields = buildList(1) {
                add(
                    pbandk.FieldDescriptor(
                        ...
                        value = com.gopro.open_gopro.operations.RequestGetCOHNStatus::registerCohnStatus
                    )
                )
            }
        )
...
internal data class NotifyCOHNStatus(
    ...
    override operator fun plus(other: pbandk.Message?): com.gopro.open_gopro.operations.NotifyCOHNStatus = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<com.gopro.open_gopro.operations.NotifyCOHNStatus> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    internal companion object : pbandk.Message.Companion<com.gopro.open_gopro.operations.NotifyCOHNStatus> {
        internal val defaultInstance: com.gopro.open_gopro.operations.NotifyCOHNStatus by lazy { com.gopro.open_gopro.operations.NotifyCOHNStatus() }
        override fun decodeWith(u: pbandk.MessageDecoder): com.gopro.open_gopro.operations.NotifyCOHNStatus = com.gopro.open_gopro.operations.NotifyCOHNStatus.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<com.gopro.open_gopro.operations.NotifyCOHNStatus> = pbandk.MessageDescriptor(
            ...
            fields = buildList(8) {
                add(
                    pbandk.FieldDescriptor(
                        ...
                        name = "status",
                        number = 1,
                        type = pbandk.FieldDescriptor.Type.Enum(enumCompanion = com.gopro.open_gopro.operations.EnumCOHNStatus.Companion, hasPresence = true),
                        jsonName = "status",
                ...
                add(
                    pbandk.FieldDescriptor(
                        ...
                        name = "state",
                        number = 2,
                        type = pbandk.FieldDescriptor.Type.Enum(enumCompanion = com.gopro.open_gopro.operations.EnumCOHNNetworkState.Companion, hasPresence = true),
                        jsonName = "state",
...
internal data class RequestCreateCOHNCert(
    ...
    override operator fun plus(other: pbandk.Message?): com.gopro.open_gopro.operations.RequestCreateCOHNCert = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<com.gopro.open_gopro.operations.RequestCreateCOHNCert> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    internal companion object : pbandk.Message.Companion<com.gopro.open_gopro.operations.RequestCreateCOHNCert> {
        internal val defaultInstance: com.gopro.open_gopro.operations.RequestCreateCOHNCert by lazy { com.gopro.open_gopro.operations.RequestCreateCOHNCert() }
        override fun decodeWith(u: pbandk.MessageDecoder): com.gopro.open_gopro.operations.RequestCreateCOHNCert = com.gopro.open_gopro.operations.RequestCreateCOHNCert.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<com.gopro.open_gopro.operations.RequestCreateCOHNCert> = pbandk.MessageDescriptor(
...
internal data class RequestClearCOHNCert(
    ...
    override operator fun plus(other: pbandk.Message?): com.gopro.open_gopro.operations.RequestClearCOHNCert = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<com.gopro.open_gopro.operations.RequestClearCOHNCert> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    internal companion object : pbandk.Message.Companion<com.gopro.open_gopro.operations.RequestClearCOHNCert> {
        internal val defaultInstance: com.gopro.open_gopro.operations.RequestClearCOHNCert by lazy { com.gopro.open_gopro.operations.RequestClearCOHNCert() }
        override fun decodeWith(u: pbandk.MessageDecoder): com.gopro.open_gopro.operations.RequestClearCOHNCert = com.gopro.open_gopro.operations.RequestClearCOHNCert.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<com.gopro.open_gopro.operations.RequestClearCOHNCert> = pbandk.MessageDescriptor(
...
internal data class RequestCOHNCert(
    ...
    override operator fun plus(other: pbandk.Message?): com.gopro.open_gopro.operations.RequestCOHNCert = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<com.gopro.open_gopro.operations.RequestCOHNCert> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    internal companion object : pbandk.Message.Companion<com.gopro.open_gopro.operations.RequestCOHNCert> {
        internal val defaultInstance: com.gopro.open_gopro.operations.RequestCOHNCert by lazy { com.gopro.open_gopro.operations.RequestCOHNCert() }
        override fun decodeWith(u: pbandk.MessageDecoder): com.gopro.open_gopro.operations.RequestCOHNCert = com.gopro.open_gopro.operations.RequestCOHNCert.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<com.gopro.open_gopro.operations.RequestCOHNCert> = pbandk.MessageDescriptor(
...
internal data class ResponseCOHNCert(
    ...
    override operator fun plus(other: pbandk.Message?): com.gopro.open_gopro.operations.ResponseCOHNCert = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<com.gopro.open_gopro.operations.ResponseCOHNCert> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    internal companion object : pbandk.Message.Companion<com.gopro.open_gopro.operations.ResponseCOHNCert> {
        internal val defaultInstance: com.gopro.open_gopro.operations.ResponseCOHNCert by lazy { com.gopro.open_gopro.operations.ResponseCOHNCert() }
        override fun decodeWith(u: pbandk.MessageDecoder): com.gopro.open_gopro.operations.ResponseCOHNCert = com.gopro.open_gopro.operations.ResponseCOHNCert.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<com.gopro.open_gopro.operations.ResponseCOHNCert> = pbandk.MessageDescriptor(
...
internal data class RequestSetCOHNSetting(
    ...
    override operator fun plus(other: pbandk.Message?): com.gopro.open_gopro.operations.RequestSetCOHNSetting = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<com.gopro.open_gopro.operations.RequestSetCOHNSetting> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    internal companion object : pbandk.Message.Companion<com.gopro.open_gopro.operations.RequestSetCOHNSetting> {
        internal val defaultInstance: com.gopro.open_gopro.operations.RequestSetCOHNSetting by lazy { com.gopro.open_gopro.operations.RequestSetCOHNSetting() }
        override fun decodeWith(u: pbandk.MessageDecoder): com.gopro.open_gopro.operations.RequestSetCOHNSetting = com.gopro.open_gopro.operations.RequestSetCOHNSetting.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<com.gopro.open_gopro.operations.RequestSetCOHNSetting> = pbandk.MessageDescriptor(
            ...
            fields = buildList(1) {
                add(
                    pbandk.FieldDescriptor(
                        ...
                        type = pbandk.FieldDescriptor.Type.Primitive.Bool(hasPresence = true),
                        jsonName = "cohnActive",
                        value = com.gopro.open_gopro.operations.RequestSetCOHNSetting::cohnActive
                    )
                )
            }
        )
...
internal fun RequestGetCOHNStatus?.orDefault(): com.gopro.open_gopro.operations.RequestGetCOHNStatus = this ?: RequestGetCOHNStatus.defaultInstance
...
internal fun NotifyCOHNStatus?.orDefault(): com.gopro.open_gopro.operations.NotifyCOHNStatus = this ?: NotifyCOHNStatus.defaultInstance
...
internal fun RequestCreateCOHNCert?.orDefault(): com.gopro.open_gopro.operations.RequestCreateCOHNCert = this ?: RequestCreateCOHNCert.defaultInstance
...
internal fun RequestClearCOHNCert?.orDefault(): com.gopro.open_gopro.operations.RequestClearCOHNCert = this ?: RequestClearCOHNCert.defaultInstance
...
internal fun RequestCOHNCert?.orDefault(): com.gopro.open_gopro.operations.RequestCOHNCert = this ?: RequestCOHNCert.defaultInstance
...
internal fun ResponseCOHNCert?.orDefault(): com.gopro.open_gopro.operations.ResponseCOHNCert = this ?: ResponseCOHNCert.defaultInstance
...
internal fun RequestSetCOHNSetting?.orDefault(): com.gopro.open_gopro.operations.RequestSetCOHNSetting = this ?: RequestSetCOHNSetting.defaultInstance
