/* MediaGetTelemetry.kt/Open GoPro, Version 2.0 (C) Copyright 2021 GoPro, Inc. (http://gopro.com/OpenGoPro). */
...
internal class MediaGetTelemetry(val file: MediaId) :
    BaseOperation<ByteArray>("Get Media File Telemetry") {
