/* PresetLoadGroup.kt/Open GoPro, Version 2.0 (C) Copyright 2021 GoPro, Inc. (http://gopro.com/OpenGoPro). */
...
internal class PresetLoadGroup(private val group: PresetGroupId) :
    BaseOperation<Unit>("Load Preset Group") {
