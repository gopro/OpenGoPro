/* SetWiredControl.kt/Open GoPro, Version 2.0 (C) Copyright 2021 GoPro, Inc. (http://gopro.com/OpenGoPro). */
...
internal class SetWiredControl(val enable: Boolean) : BaseOperation<Unit>("Set Wired Control") {
