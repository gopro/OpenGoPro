...
sealed class MediaMetadata {
    ...
    @Transient
    @SerialName("rot")
    open val deprecated: String? = null // deprecated
...
data class VideoMediaMetadata(
    ...
    @SerialName("eis") @Serializable(with = StringAsBooleanSerializer::class) override val isStabilized: Boolean,
    @SerialName("mp") @Serializable(with = StringAsBooleanSerializer::class) override val isMetadataPresent: Boolean,
    @SerialName("tr") @Serializable(with = StringAsBooleanSerializer::class) override val isTranscoded: Boolean,
    @SerialName("us") @Serializable(with = StringAsBooleanSerializer::class) override val isUploaded: Boolean,
    ...
    @SerialName("pta") @Serializable(with = StringAsBooleanSerializer::class) val isProtuneAudio: Boolean,
    @SerialName("subsample") @Serializable(with = StringAsBooleanSerializer::class) val isSubsampled: Boolean,
    @SerialName("mahs") val maxAutoHilightScore: Int ? = null,
    @SerialName("prog") @Serializable(with = StringAsBooleanSerializer::class) val isProgressive: Boolean? = null
) : MediaMetadata()
...
data class PhotoMediaMetadata(
    ...
    @SerialName("raw") @Serializable(with = StringAsBooleanSerializer::class) val isRaw: Boolean? = null,
    @SerialName("wdr") @Serializable(with = StringAsBooleanSerializer::class) val isWideDynamicRange: Boolean? = null,
    @SerialName("hdr") @Serializable(with = StringAsBooleanSerializer::class) val isHighDynamicRange: Boolean? = null,
) : MediaMetadata()