...
class TestMediaList {
  ...
  fun `parse single media list item`() {
    // WHEN
    val singleMediaListItem = jsonDefault.decodeFromString<MediaListItem>(singleMediaListItemJson)
  ...
  fun `parse grouped media list item`() {
    ...
    val singleMediaListItem =
        jsonDefault.decodeFromString<MediaListItem>(groupedMediaListItemJson)
            as GroupedMediaListItem
