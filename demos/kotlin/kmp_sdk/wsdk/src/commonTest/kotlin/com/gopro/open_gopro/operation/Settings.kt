...
class TestSettings {
  ...
  //    // GIVEN
  //    val responses =
  //        listOf(listOf(BleNotification(GpUuid.CQ_QUERY_RESP.toUuid(),
  // getScheduledCaptureResponseMessage)))
  //    val fakeSettingsContainer = buildFakeSettingsContainer(responses,
