...
import open_gopro.EnumLens
import open_gopro.EnumLiveStreamError
import open_gopro.EnumLiveStreamStatus
...
import open_gopro.EnumRegisterLiveStreamStatus
import open_gopro.EnumRegisterPresetStatus
import open_gopro.EnumResultGeneric
import open_gopro.EnumScanning
import open_gopro.EnumWindowSize
import open_gopro.NotifProvisioningState
import open_gopro.NotifStartScanning
import open_gopro.NotifyLiveStreamStatus
import open_gopro.NotifyPresetStatus
import open_gopro.Preset
import open_gopro.PresetGroup
import open_gopro.PresetSetting
import open_gopro.RequestGetLiveStreamStatus
...
val localDateTimeVector = LocalDateTime(
    hour = 3,
    minute = 4,
    second = 5,
    year = 2023,
...
val dateTimeResponsePayload =
    ubyteArrayOf(
        ...
        // param size
        0x0AU
    ) + localDateTimeBytes + utcOffsetBytes + ubyteArrayOf(0x01U)
...
val initialApScanResponse = ubyteArrayOf(
    FeatureId.NETWORK_MANAGEMENT.value,
    ActionId.SCAN_WIFI_NETWORKS_RSP.value
) + ResponseStartScanning(
    EnumResultGeneric.RESULT_SUCCESS,
    EnumScanning.SCANNING_STARTED
).encodeToByteArray().toUByteArray()
val initialApScanResponseFailure = ubyteArrayOf(
    FeatureId.NETWORK_MANAGEMENT.value,
    ActionId.SCAN_WIFI_NETWORKS_RSP.value
) + ResponseStartScanning(
    EnumResultGeneric.RESULT_ILL_FORMED,
    EnumScanning.SCANNING_NEVER_STARTED
).encodeToByteArray().toUByteArray()
val intermediateApScanNotification = ubyteArrayOf(
    FeatureId.NETWORK_MANAGEMENT.value,
    ActionId.NOTIF_START_SCAN.value
) + NotifStartScanning(
...
val finalApScanNotification = ubyteArrayOf(
    FeatureId.NETWORK_MANAGEMENT.value,
    ActionId.NOTIF_START_SCAN.value
) + NotifStartScanning(
...
val getApScanResultsResponse = ubyteArrayOf(
    FeatureId.NETWORK_MANAGEMENT.value,
    ActionId.GET_AP_ENTRIES_RSP.value
...
val connectNewAccessPointResponseSuccess =
    ubyteArrayOf(
        FeatureId.NETWORK_MANAGEMENT.value,
        ActionId.REQUEST_WIFI_CONNECT_NEW_RSP.value
    ) + ResponseConnectNew(
        result = EnumResultGeneric.RESULT_SUCCESS,
...
val connectAccessPointOngoing =
    ubyteArrayOf(
        FeatureId.NETWORK_MANAGEMENT.value,
        ActionId.NOTIF_PROVIS_STATE.value
...
val connectAccessPointComplete =
    ubyteArrayOf(
        ...
        provisioningState = EnumProvisioning.PROVISIONING_SUCCESS_NEW_AP
    ).encodeToByteArray().toUByteArray()
val connectAccessPointFailureSuccess =
    ubyteArrayOf(
        FeatureId.NETWORK_MANAGEMENT.value,
        ActionId.REQUEST_WIFI_CONNECT_RSP.value
    ) + ResponseConnectNew(
        result = EnumResultGeneric.RESULT_SUCCESS,
...
val hardwareInfoResponsePayload =
    ubyteArrayOf(CommandId.GET_HARDWARE_INFO.value, GpStatus.SUCCESS.value) +
            ubyteArrayOf("modelNumber".length.toUByte()) + "modelNumber".encodeToUByteArray() +
            ubyteArrayOf("modelName".length.toUByte()) + "modelName".encodeToUByteArray() +
            ubyteArrayOf("deprecated".length.toUByte()) + "deprecated".encodeToUByteArray() +
            ubyteArrayOf("firmwareVersion".length.toUByte()) + "firmwareVersion".encodeToUByteArray() +
            ubyteArrayOf("serialNumber".length.toUByte()) + "serialNumber".encodeToUByteArray() +
            ubyteArrayOf("apSsid".length.toUByte()) + "apSsid".encodeToUByteArray() +
            ubyteArrayOf("apMacAddress".length.toUByte()) + "apMacAddress".encodeToUByteArray()
val getLivestreamStatusResponse1 = ubyteArrayOf(
    FeatureId.QUERY.value,
    ActionId.LIVESTREAM_STATUS_RSP.value
...
val getLivestreamStatusNoti1 = ubyteArrayOf(
    FeatureId.QUERY.value,
    ActionId.LIVESTREAM_STATUS_NOTIF.value
) + NotifyLiveStreamStatus(
    liveStreamStatus = EnumLiveStreamStatus.LIVE_STREAM_STATE_CONFIG,
    liveStreamMaximumStreamBitrate = 100,
    liveStreamMinimumStreamBitrate = 0,
...
val getLivestreamStatusNoti2 = ubyteArrayOf(
    FeatureId.QUERY.value,
    ActionId.LIVESTREAM_STATUS_NOTIF.value
) + NotifyLiveStreamStatus(
    liveStreamStatus = EnumLiveStreamStatus.LIVE_STREAM_STATE_CONFIG,
...
val getLivestreamStatusNoti3 = ubyteArrayOf(
    FeatureId.QUERY.value,
    ActionId.LIVESTREAM_STATUS_NOTIF.value
) + NotifyLiveStreamStatus(
    liveStreamStatus = EnumLiveStreamStatus.LIVE_STREAM_STATE_CONFIG,
...
val unregisterLivestreamStatusRequest = ubyteArrayOf(
    FeatureId.QUERY.value,
    ActionId.GET_LIVESTREAM_STATUS.value
...
val completeNotifyPresetStatus = NotifyPresetStatus(
    presetGroupArray = listOf(
        PresetGroup(
...
val unregisterPresetInfoRequest =
    ubyteArrayOf(FeatureId.QUERY.value, ActionId.GET_PRESET_STATUS.value) + RequestGetPresetStatus(
        unregisterPresetStatus = listOf(EnumRegisterPresetStatus.REGISTER_PRESET_STATUS_PRESET)
    ).encodeToByteArray().toUByteArray()

val complexBleWriteResponse = ubyteArrayOf(
    0x21U,
    0x72U,
    0x13U,
    0x00U,
...
val advertisementData = ubyteArrayOf(
    0x02U,
    0x01U,
    0x02U,
    0x03U,
...
val scanResponseData = ubyteArrayOf(
    0x0BU,
    0x09U,
    0x47U,
    0x6FU,
