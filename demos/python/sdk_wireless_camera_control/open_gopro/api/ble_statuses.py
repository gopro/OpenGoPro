...
class BleStatuses(BleMessages[BleStatus.BleStatusMessageBase]):
    ...
    def __init__(self, communicator: GoProBle) -> None:
        ...
        self.pairing_state_legacy_: BleStatus[int] = BleStatus(communicator, StatusId.PAIRING_STATE_LEGACY_, Int32ub)
        ...
        self.flatmode: BleStatus[int] = BleStatus(communicator, StatusId.FLATMODE, Int32ub)
        """Flatmode
