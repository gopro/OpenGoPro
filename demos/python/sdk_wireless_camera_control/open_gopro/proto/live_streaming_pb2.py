...
_ENUMLENS = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="LENS_WIDE", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="LENS_LINEAR", index=1, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="LENS_SUPERVIEW", index=2, number=3, serialized_options=None, type=None
        ),
    ],
...
_ENUMLIVESTREAMERROR = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="LIVE_STREAM_ERROR_SELECTEDNETWORKTIMEOUT",
            index=7,
            number=7,
            serialized_options=None,
            type=None,
...
_ENUMWINDOWSIZE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="WINDOW_SIZE_480", index=0, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="WINDOW_SIZE_720", index=1, number=7, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
...
_NOTIFYLIVESTREAMSTATUS = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="deprecated",
            full_name="open_gopro.NotifyLiveStreamStatus.deprecated",
            index=11,
            number=12,
            type=8,
            cpp_type=7,
...
_REQUESTSETLIVESTREAMMODE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="reserved1",
            full_name="open_gopro.RequestSetLiveStreamMode.reserved1",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="reserved2",
            full_name="open_gopro.RequestSetLiveStreamMode.reserved2",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="reserved3",
            full_name="open_gopro.RequestSetLiveStreamMode.reserved3",
            index=10,
            number=11,
            type=5,
            cpp_type=1,
...
_REQUESTGETLIVESTREAMSTATUS.fields_by_name[
    "register_live_stream_status"
].enum_type = _ENUMREGISTERLIVESTREAMSTATUS
_REQUESTGETLIVESTREAMSTATUS.fields_by_name[
