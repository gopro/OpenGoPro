...
class NotifyLiveStreamStatus(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        live_stream_status: typing.Optional[global___EnumLiveStreamStatus.ValueType] = ...,
        live_stream_error: typing.Optional[global___EnumLiveStreamError.ValueType] = ...,
        live_stream_encode: typing.Optional[builtins.bool] = ...,
        live_stream_bitrate: typing.Optional[builtins.int] = ...,
        live_stream_window_size_supported_array: typing.Optional[
            typing.Iterable[global___EnumWindowSize.ValueType]
        ] = ...,
        live_stream_encode_supported: typing.Optional[builtins.bool] = ...,
        live_stream_max_lens_unsupported: typing.Optional[builtins.bool] = ...,
        live_stream_minimum_stream_bitrate: typing.Optional[builtins.int] = ...,
        live_stream_maximum_stream_bitrate: typing.Optional[builtins.int] = ...,
        live_stream_lens_supported: typing.Optional[builtins.bool] = ...,
        live_stream_lens_supported_array: typing.Optional[typing.Iterable[global___EnumLens.ValueType]] = ...,
...
class RequestGetLiveStreamStatus(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        register_live_stream_status: typing.Optional[
            typing.Iterable[global___EnumRegisterLiveStreamStatus.ValueType]
        ] = ...,
        unregister_live_stream_status: typing.Optional[
            typing.Iterable[global___EnumRegisterLiveStreamStatus.ValueType]
        ] = ...
    ) -> None: ...
    def ClearField(
...
class RequestSetLiveStreamMode(google.protobuf.message.Message):
    ...
    reserved1: typing.Text
    reserved2: typing.Text
    cert: builtins.bytes
    ...
    def __init__(
        ...
        *,
        ...
        encode: typing.Optional[builtins.bool] = ...,
        window_size: typing.Optional[global___EnumWindowSize.ValueType] = ...,
        reserved1: typing.Optional[typing.Text] = ...,
        reserved2: typing.Optional[typing.Text] = ...,
        cert: typing.Optional[builtins.bytes] = ...,
        minimum_bitrate: typing.Optional[builtins.int] = ...,
        maximum_bitrate: typing.Optional[builtins.int] = ...,
        starting_bitrate: typing.Optional[builtins.int] = ...,
        lens: typing.Optional[global___EnumLens.ValueType] = ...,
        reserved3: typing.Optional[builtins.int] = ...
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
