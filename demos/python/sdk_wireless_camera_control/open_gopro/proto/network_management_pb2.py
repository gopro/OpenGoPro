...
_ENUMNETWORKOWNER = _descriptor.EnumDescriptor(
    name="EnumNetworkOwner",
    full_name="open_gopro.EnumNetworkOwner",
    filename=None,
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(
            name="DEPRECATED_1", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DEPRECATED_2", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DEPRECATED_3", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DEPRECATED_4", index=3, number=3, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DEPRECATED_5", index=4, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DEPRECATED_6", index=5, number=8, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DEPRECATED_7", index=6, number=16, serialized_options=None, type=None
        ),
    ],
...
_sym_db.RegisterEnumDescriptor(_ENUMNETWORKOWNER)
EnumNetworkOwner = enum_type_wrapper.EnumTypeWrapper(_ENUMNETWORKOWNER)
_ENUMPROVISIONING = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="PROVISIONING_ERROR_FAILED_TO_ASSOCIATE",
            index=7,
            number=7,
            serialized_options=None,
            type=None,
...
_ENUMSCANNING = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="SCANNING_UNKNOWN", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="SCANNING_NEVER_STARTED", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="SCANNING_STARTED", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
        ...
        _descriptor.EnumValueDescriptor(
            name="SCANNING_SUCCESS", index=5, number=5, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
...
_ENUMSCANENTRYFLAGS = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="SCAN_FLAG_OPEN", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
        ...
        _descriptor.EnumValueDescriptor(
            name="DEPRECATED", index=6, number=32, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
...
_REQUESTCONNECTNEW = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="set_to_least_preferred_ap",
            full_name="open_gopro.RequestConnectNew.set_to_least_preferred_ap",
            index=7,
            number=8,
            type=8,
            cpp_type=7,
...
_SCANENTRY = _descriptor.Descriptor(
    name="ScanEntry",
    full_name="open_gopro.ScanEntry",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="ssid",
            full_name="open_gopro.ScanEntry.ssid",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="open_gopro.ScanEntry.signal_strength_bars",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="open_gopro.ScanEntry.signal_frequency_mhz",
            index=2,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="open_gopro.ScanEntry.scan_entry_flags",
            index=3,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="owner_purpose",
            full_name="open_gopro.ScanEntry.owner_purpose",
            index=4,
            number=6,
            type=14,
            cpp_type=8,
...
_REQUESTCONNECT.fields_by_name["owner_purpose"].enum_type = _ENUMNETWORKOWNER
_REQUESTCONNECTNEW.fields_by_name["owner_purpose"].enum_type = _ENUMNETWORKOWNER
...
_SCANENTRY.fields_by_name["owner_purpose"].enum_type = _ENUMNETWORKOWNER
_RESPONSEGETAPENTRIES.fields_by_name["result"].enum_type = response__generic__pb2._ENUMRESULTGENERIC
_RESPONSEGETAPENTRIES.fields_by_name["entries"].message_type = _SCANENTRY
...
DESCRIPTOR.message_types_by_name["ScanEntry"] = _SCANENTRY
...
DESCRIPTOR.enum_types_by_name["EnumNetworkOwner"] = _ENUMNETWORKOWNER
...
NotifStartScanning = _reflection.GeneratedProtocolMessageType(
    "NotifStartScanning",
    (_message.Message,),
    dict(DESCRIPTOR=_NOTIFSTARTSCANNING, __module__="network_management_pb2"),
)
_sym_db.RegisterMessage(NotifStartScanning)
RequestConnect = _reflection.GeneratedProtocolMessageType(
    "RequestConnect",
    (_message.Message,),
    dict(DESCRIPTOR=_REQUESTCONNECT, __module__="network_management_pb2"),
)
_sym_db.RegisterMessage(RequestConnect)
RequestConnectNew = _reflection.GeneratedProtocolMessageType(
    "RequestConnectNew",
    (_message.Message,),
    dict(DESCRIPTOR=_REQUESTCONNECTNEW, __module__="network_management_pb2"),
)
...
RequestStartScan = _reflection.GeneratedProtocolMessageType(
    "RequestStartScan",
    (_message.Message,),
    dict(DESCRIPTOR=_REQUESTSTARTSCAN, __module__="network_management_pb2"),
)
_sym_db.RegisterMessage(RequestStartScan)
ResponseConnect = _reflection.GeneratedProtocolMessageType(
    "ResponseConnect",
    (_message.Message,),
    dict(DESCRIPTOR=_RESPONSECONNECT, __module__="network_management_pb2"),
)
_sym_db.RegisterMessage(ResponseConnect)
ResponseConnectNew = _reflection.GeneratedProtocolMessageType(
    "ResponseConnectNew",
    (_message.Message,),
    dict(DESCRIPTOR=_RESPONSECONNECTNEW, __module__="network_management_pb2"),
)
_sym_db.RegisterMessage(ResponseConnectNew)
ScanEntry = _reflection.GeneratedProtocolMessageType(
    "ScanEntry", (_message.Message,), dict(DESCRIPTOR=_SCANENTRY, __module__="network_management_pb2")
)
_sym_db.RegisterMessage(ScanEntry)
ResponseGetApEntries = _reflection.GeneratedProtocolMessageType(
    "ResponseGetApEntries",
    (_message.Message,),
    dict(DESCRIPTOR=_RESPONSEGETAPENTRIES, __module__="network_management_pb2"),
)
