...
class NotifyPresetStatus(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, preset_group_array: typing.Optional[typing.Iterable[global___PresetGroup]] = ...
    ) -> None: ...
    def ClearField(
...
class Preset(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        mode: typing.Optional[global___EnumFlatMode.ValueType] = ...,
        title_id: typing.Optional[global___EnumPresetTitle.ValueType] = ...,
        title_number: typing.Optional[builtins.int] = ...,
        user_defined: typing.Optional[builtins.bool] = ...,
        icon: typing.Optional[global___EnumPresetIcon.ValueType] = ...,
        setting_array: typing.Optional[typing.Iterable[global___PresetSetting]] = ...,
        is_modified: typing.Optional[builtins.bool] = ...,
        is_fixed: typing.Optional[builtins.bool] = ...
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
...
class PresetSetting(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        is_caption: typing.Optional[builtins.bool] = ...
    ) -> None: ...
    def HasField(
        self,
