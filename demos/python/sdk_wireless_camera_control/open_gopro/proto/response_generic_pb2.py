...
_ENUMRESULTGENERIC = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name="RESULT_UNKNOWN", index=0, number=0, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="RESULT_SUCCESS", index=1, number=1, serialized_options=None, type=None),
        ...
        _descriptor.EnumValueDescriptor(
            name="RESULT_RESOURCE_NOT_AVAILABLE", index=6, number=6, serialized_options=None, type=None
        ),
    ],
...
_MEDIA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="folder",
            full_name="open_gopro.Media.folder",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="file",
            full_name="open_gopro.Media.file",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
ResponseGeneric = _reflection.GeneratedProtocolMessageType(
    "ResponseGeneric", (_message.Message,), dict(DESCRIPTOR=_RESPONSEGENERIC, __module__="response_generic_pb2")
)
_sym_db.RegisterMessage(ResponseGeneric)
Media = _reflection.GeneratedProtocolMessageType(
    "Media", (_message.Message,), dict(DESCRIPTOR=_MEDIA, __module__="response_generic_pb2")
)
