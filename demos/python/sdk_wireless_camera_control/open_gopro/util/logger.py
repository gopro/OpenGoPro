...
class Logger:
    ...
    def __init__(
        ...
        self.modules = [
            ...
            "open_gopro.features.streaming.stream_feature",
            "open_gopro.features.streaming.webcam_stream",
            "open_gopro.features.streaming.livestream",
            "open_gopro.features.streaming.preview_stream",
            "open_gopro.util.util",
            "open_gopro.demos.gui.util",
