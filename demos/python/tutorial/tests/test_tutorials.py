...
from tutorial_modules.tutorial_6_send_wifi_commands.wifi_command_set_resolution import (
...
from tutorial_modules.tutorial_7_camera_media_list.wifi_media_get_thumbnail import (
