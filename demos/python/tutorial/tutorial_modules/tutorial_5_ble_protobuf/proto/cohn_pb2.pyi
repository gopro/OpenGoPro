...
class _EnumCOHNStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumCOHNStatus.ValueType], builtins.type):
...
class _EnumCOHNNetworkStateEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumCOHNNetworkState.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class RequestGetCOHNStatus(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[('register_cohn_status', b'register_cohn_status')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('register_cohn_status', b'register_cohn_status')]) -> None:
        ...
...
class NotifyCOHNStatus(google.protobuf.message.Message):
    ...
    def __init__(self, *, status: (global___EnumCOHNStatus.ValueType | None)=..., state: (global___EnumCOHNNetworkState.ValueType | None)=..., username: (builtins.str | None)=..., password: (builtins.str | None)=..., ipaddress: (builtins.str | None)=..., enabled: (builtins.bool | None)=..., ssid: (builtins.str | None)=..., macaddress: (builtins.str | None)=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal[('enabled', b'enabled', 'ipaddress', b'ipaddress', 'macaddress', b'macaddress', 'password', b'password', 'ssid', b'ssid', 'state', b'state', 'status', b'status', 'username', b'username')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('enabled', b'enabled', 'ipaddress', b'ipaddress', 'macaddress', b'macaddress', 'password', b'password', 'ssid', b'ssid', 'state', b'state', 'status', b'status', 'username', b'username')]) -> None:
        ...
...
class ResponseCOHNCert(google.protobuf.message.Message):
    ...
    def __init__(self, *, result: (response_generic_pb2.EnumResultGeneric.ValueType | None)=..., cert: (builtins.str | None)=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal[('cert', b'cert', 'result', b'result')]) -> builtins.bool:
        ...
