...
class _EnumLensEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumLens.ValueType], builtins.type):
...
class _EnumLiveStreamErrorEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumLiveStreamError.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _EnumLiveStreamStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumLiveStreamStatus.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _EnumRegisterLiveStreamStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumRegisterLiveStreamStatus.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class EnumRegisterLiveStreamStatus(_EnumRegisterLiveStreamStatus, metaclass=_EnumRegisterLiveStreamStatusEnumTypeWrapper):
    ...
...
class _EnumWindowSizeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumWindowSize.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class NotifyLiveStreamStatus(google.protobuf.message.Message):
    ...
    @property
    def live_stream_window_size_supported_array(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[global___EnumWindowSize.ValueType]:
    ...
    @property
    def live_stream_lens_supported_array(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[global___EnumLens.ValueType]:
    ...
    def __init__(self, *, live_stream_status: (global___EnumLiveStreamStatus.ValueType | None)=..., live_stream_error: (global___EnumLiveStreamError.ValueType | None)=..., live_stream_encode: (builtins.bool | None)=..., live_stream_bitrate: (builtins.int | None)=..., live_stream_window_size_supported_array: (collections.abc.Iterable[global___EnumWindowSize.ValueType] | None)=..., live_stream_encode_supported: (builtins.bool | None)=..., live_stream_max_lens_unsupported: (builtins.bool | None)=..., live_stream_minimum_stream_bitrate: (builtins.int | None)=..., live_stream_maximum_stream_bitrate: (builtins.int | None)=..., live_stream_lens_supported: (builtins.bool | None)=..., live_stream_lens_supported_array: (collections.abc.Iterable[global___EnumLens.ValueType] | None)=..., live_stream_protune_supported: (builtins.bool | None)=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal[('live_stream_bitrate', b'live_stream_bitrate', 'live_stream_encode', b'live_stream_encode', 'live_stream_encode_supported', b'live_stream_encode_supported', 'live_stream_error', b'live_stream_error', 'live_stream_lens_supported', b'live_stream_lens_supported', 'live_stream_max_lens_unsupported', b'live_stream_max_lens_unsupported', 'live_stream_maximum_stream_bitrate', b'live_stream_maximum_stream_bitrate', 'live_stream_minimum_stream_bitrate', b'live_stream_minimum_stream_bitrate', 'live_stream_protune_supported', b'live_stream_protune_supported', 'live_stream_status', b'live_stream_status')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('live_stream_bitrate', b'live_stream_bitrate', 'live_stream_encode', b'live_stream_encode', 'live_stream_encode_supported', b'live_stream_encode_supported', 'live_stream_error', b'live_stream_error', 'live_stream_lens_supported', b'live_stream_lens_supported', 'live_stream_lens_supported_array', b'live_stream_lens_supported_array', 'live_stream_max_lens_unsupported', b'live_stream_max_lens_unsupported', 'live_stream_maximum_stream_bitrate', b'live_stream_maximum_stream_bitrate', 'live_stream_minimum_stream_bitrate', b'live_stream_minimum_stream_bitrate', 'live_stream_protune_supported', b'live_stream_protune_supported', 'live_stream_status', b'live_stream_status', 'live_stream_window_size_supported_array', b'live_stream_window_size_supported_array')]) -> None:
        ...
...
class RequestGetLiveStreamStatus(google.protobuf.message.Message):
    ...
    @property
    def register_live_stream_status(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[global___EnumRegisterLiveStreamStatus.ValueType]:
        'Array of live stream statuses to be notified about'

    @property
    def unregister_live_stream_status(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[global___EnumRegisterLiveStreamStatus.ValueType]:
        'Array of live stream statuses to stop being notified about'

    def __init__(self, *, register_live_stream_status: (collections.abc.Iterable[global___EnumRegisterLiveStreamStatus.ValueType] | None)=..., unregister_live_stream_status: (collections.abc.Iterable[global___EnumRegisterLiveStreamStatus.ValueType] | None)=...) -> None:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('register_live_stream_status', b'register_live_stream_status', 'unregister_live_stream_status', b'unregister_live_stream_status')]) -> None:
        ...
...
class RequestSetLiveStreamMode(google.protobuf.message.Message):
    ...
    def __init__(self, *, url: (builtins.str | None)=..., encode: (builtins.bool | None)=..., window_size: (global___EnumWindowSize.ValueType | None)=..., cert: (builtins.bytes | None)=..., minimum_bitrate: (builtins.int | None)=..., maximum_bitrate: (builtins.int | None)=..., starting_bitrate: (builtins.int | None)=..., lens: (global___EnumLens.ValueType | None)=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal[('cert', b'cert', 'encode', b'encode', 'lens', b'lens', 'maximum_bitrate', b'maximum_bitrate', 'minimum_bitrate', b'minimum_bitrate', 'starting_bitrate', b'starting_bitrate', 'url', b'url', 'window_size', b'window_size')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('cert', b'cert', 'encode', b'encode', 'lens', b'lens', 'maximum_bitrate', b'maximum_bitrate', 'minimum_bitrate', b'minimum_bitrate', 'starting_bitrate', b'starting_bitrate', 'url', b'url', 'window_size', b'window_size')]) -> None:
        ...
