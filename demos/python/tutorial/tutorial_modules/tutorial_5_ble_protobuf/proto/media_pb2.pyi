...
class ResponseLastCapturedMedia(google.protobuf.message.Message):
    ...
    def __init__(self, *, result: (response_generic_pb2.EnumResultGeneric.ValueType | None)=..., media: (response_generic_pb2.Media | None)=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal[('media', b'media', 'result', b'result')]) -> builtins.bool:
        ...
