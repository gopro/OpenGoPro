...
class _EnumProvisioningEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumProvisioning.ValueType], builtins.type):
...
class _EnumScanningEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumScanning.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _EnumScanEntryFlagsEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumScanEntryFlags.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class NotifProvisioningState(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[('provisioning_state', b'provisioning_state')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('provisioning_state', b'provisioning_state')]) -> None:
        ...
...
class NotifStartScanning(google.protobuf.message.Message):
    ...
    def __init__(self, *, scanning_state: (global___EnumScanning.ValueType | None)=..., scan_id: (builtins.int | None)=..., total_entries: (builtins.int | None)=..., total_configured_ssid: (builtins.int | None)=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal[('scan_id', b'scan_id', 'scanning_state', b'scanning_state', 'total_configured_ssid', b'total_configured_ssid', 'total_entries', b'total_entries')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('scan_id', b'scan_id', 'scanning_state', b'scanning_state', 'total_configured_ssid', b'total_configured_ssid', 'total_entries', b'total_entries')]) -> None:
        ...
...
class RequestConnectNew(google.protobuf.message.Message):
    ...
    def __init__(self, *, ssid: (builtins.str | None)=..., password: (builtins.str | None)=..., static_ip: (builtins.bytes | None)=..., gateway: (builtins.bytes | None)=..., subnet: (builtins.bytes | None)=..., dns_primary: (builtins.bytes | None)=..., dns_secondary: (builtins.bytes | None)=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal[('dns_primary', b'dns_primary', 'dns_secondary', b'dns_secondary', 'gateway', b'gateway', 'password', b'password', 'ssid', b'ssid', 'static_ip', b'static_ip', 'subnet', b'subnet')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('dns_primary', b'dns_primary', 'dns_secondary', b'dns_secondary', 'gateway', b'gateway', 'password', b'password', 'ssid', b'ssid', 'static_ip', b'static_ip', 'subnet', b'subnet')]) -> None:
        ...
...
class RequestGetApEntries(google.protobuf.message.Message):
    ...
    def __init__(self, *, start_index: (builtins.int | None)=..., max_entries: (builtins.int | None)=..., scan_id: (builtins.int | None)=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal[('max_entries', b'max_entries', 'scan_id', b'scan_id', 'start_index', b'start_index')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('max_entries', b'max_entries', 'scan_id', b'scan_id', 'start_index', b'start_index')]) -> None:
        ...
...
class ResponseConnect(google.protobuf.message.Message):
    ...
    def __init__(self, *, result: (response_generic_pb2.EnumResultGeneric.ValueType | None)=..., provisioning_state: (global___EnumProvisioning.ValueType | None)=..., timeout_seconds: (builtins.int | None)=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal[('provisioning_state', b'provisioning_state', 'result', b'result', 'timeout_seconds', b'timeout_seconds')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('provisioning_state', b'provisioning_state', 'result', b'result', 'timeout_seconds', b'timeout_seconds')]) -> None:
        ...
...
class ResponseGetApEntries(google.protobuf.message.Message):
    ...
    class ScanEntry(google.protobuf.message.Message):
        ...
        def __init__(self, *, ssid: (builtins.str | None)=..., signal_strength_bars: (builtins.int | None)=..., signal_frequency_mhz: (builtins.int | None)=..., scan_entry_flags: (builtins.int | None)=...) -> None:
            ...

        def HasField(self, field_name: typing_extensions.Literal[('scan_entry_flags', b'scan_entry_flags', 'signal_frequency_mhz', b'signal_frequency_mhz', 'signal_strength_bars', b'signal_strength_bars', 'ssid', b'ssid')]) -> builtins.bool:
            ...

        def ClearField(self, field_name: typing_extensions.Literal[('scan_entry_flags', b'scan_entry_flags', 'signal_frequency_mhz', b'signal_frequency_mhz', 'signal_strength_bars', b'signal_strength_bars', 'ssid', b'ssid')]) -> None:
            ...
    RESULT_FIELD_NUMBER: builtins.int
    SCAN_ID_FIELD_NUMBER: builtins.int
    ...
    @property
    def entries(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ResponseGetApEntries.ScanEntry]:
        'Array containing details about discovered APs'

    def __init__(self, *, result: (response_generic_pb2.EnumResultGeneric.ValueType | None)=..., scan_id: (builtins.int | None)=..., entries: (collections.abc.Iterable[global___ResponseGetApEntries.ScanEntry] | None)=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal[('result', b'result', 'scan_id', b'scan_id')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('entries', b'entries', 'result', b'result', 'scan_id', b'scan_id')]) -> None:
        ...
...
class ResponseStartScanning(google.protobuf.message.Message):
    ...
    def __init__(self, *, result: (response_generic_pb2.EnumResultGeneric.ValueType | None)=..., scanning_state: (global___EnumScanning.ValueType | None)=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal[('result', b'result', 'scanning_state', b'scanning_state')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('result', b'result', 'scanning_state', b'scanning_state')]) -> None:
        ...
