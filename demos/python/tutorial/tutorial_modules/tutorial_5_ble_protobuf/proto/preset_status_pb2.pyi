...
class _EnumFlatModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumFlatMode.ValueType], builtins.type):
...
class _EnumPresetGroupEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumPresetGroup.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _EnumPresetGroupIconEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumPresetGroupIcon.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _EnumPresetIconEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumPresetIcon.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _EnumPresetTitleEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumPresetTitle.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class NotifyPresetStatus(google.protobuf.message.Message):
    ...
    @property
    def preset_group_array(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PresetGroup]:
    ...
    def ClearField(self, field_name: typing_extensions.Literal[('preset_group_array', b'preset_group_array')]) -> None:
        ...
...
class Preset(google.protobuf.message.Message):
    ...
    @property
    def setting_array(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PresetSetting]:
    ...
    def HasField(self, field_name: typing_extensions.Literal[('custom_name', b'custom_name', 'icon', b'icon', 'id', b'id', 'is_fixed', b'is_fixed', 'is_modified', b'is_modified', 'mode', b'mode', 'title_id', b'title_id', 'title_number', b'title_number', 'user_defined', b'user_defined')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('custom_name', b'custom_name', 'icon', b'icon', 'id', b'id', 'is_fixed', b'is_fixed', 'is_modified', b'is_modified', 'mode', b'mode', 'setting_array', b'setting_array', 'title_id', b'title_id', 'title_number', b'title_number', 'user_defined', b'user_defined')]) -> None:
        ...
...
class RequestCustomPresetUpdate(google.protobuf.message.Message):
    ...
    def __init__(self, *, title_id: (global___EnumPresetTitle.ValueType | None)=..., custom_name: (builtins.str | None)=..., icon_id: (global___EnumPresetIcon.ValueType | None)=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal[('custom_name', b'custom_name', 'icon_id', b'icon_id', 'title_id', b'title_id')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('custom_name', b'custom_name', 'icon_id', b'icon_id', 'title_id', b'title_id')]) -> None:
        ...
...
class PresetGroup(google.protobuf.message.Message):
    ...
    @property
    def mode_array(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[global___EnumFlatMode.ValueType]:
        'A list of flatmodes available for this preset group'

    def __init__(self, *, id: (global___EnumPresetGroup.ValueType | None)=..., preset_array: (collections.abc.Iterable[global___Preset] | None)=..., can_add_preset: (builtins.bool | None)=..., icon: (global___EnumPresetGroupIcon.ValueType | None)=..., mode_array: (collections.abc.Iterable[global___EnumFlatMode.ValueType] | None)=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal[('can_add_preset', b'can_add_preset', 'icon', b'icon', 'id', b'id')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('can_add_preset', b'can_add_preset', 'icon', b'icon', 'id', b'id', 'mode_array', b'mode_array', 'preset_array', b'preset_array')]) -> None:
        ...
...
class PresetSetting(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: (builtins.int | None)=..., value: (builtins.int | None)=..., is_caption: (builtins.bool | None)=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal[('id', b'id', 'is_caption', b'is_caption', 'value', b'value')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('id', b'id', 'is_caption', b'is_caption', 'value', b'value')]) -> None:
        ...
