...
class _EnumRegisterPresetStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumRegisterPresetStatus.ValueType], builtins.type):
...
class RequestGetPresetStatus(google.protobuf.message.Message):
    ...
    @property
    def register_preset_status(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[global___EnumRegisterPresetStatus.ValueType]:
        'Array of Preset statuses to be notified about'

    @property
    def unregister_preset_status(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[global___EnumRegisterPresetStatus.ValueType]:
        'Array of Preset statuses to stop being notified about'

    def __init__(self, *, register_preset_status: (collections.abc.Iterable[global___EnumRegisterPresetStatus.ValueType] | None)=..., unregister_preset_status: (collections.abc.Iterable[global___EnumRegisterPresetStatus.ValueType] | None)=...) -> None:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('register_preset_status', b'register_preset_status', 'unregister_preset_status', b'unregister_preset_status')]) -> None:
        ...
