...
RequestSetCameraControlStatus = _reflection.GeneratedProtocolMessageType('RequestSetCameraControlStatus', (_message.Message,), dict(DESCRIPTOR=_REQUESTSETCAMERACONTROLSTATUS, __module__='set_camera_control_status_pb2'))
