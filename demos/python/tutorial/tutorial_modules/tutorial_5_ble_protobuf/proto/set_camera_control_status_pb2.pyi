...
class _EnumCameraControlStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnumCameraControlStatus.ValueType], builtins.type):
...
class RequestSetCameraControlStatus(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[('camera_control_status', b'camera_control_status')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal[('camera_control_status', b'camera_control_status')]) -> None:
        ...
