...
def main():
    ...
    shutter_on_url = GOPRO_BASE_URL + f"/gopro/camera/shutter/start"
    ...
    # Build the HTTP GET request
    shutter_off_url = GOPRO_BASE_URL + f"/gopro/camera/shutter/stop"
    logger.info(f"Turning the shutter on: sending {shutter_off_url}")
