/* file.kt/Open GoPro, Version 2.0 (C) Copyright 2021 GoPro, Inc. (http://gopro.com/OpenGoPro). */
...
internal sealed class EnumFlatMode(override val value: Int, override val name: String? = null) : pbandk.Message.Enum {
    ...
    internal object FLAT_MODE_VIDEO_LIGHT_PAINTING : EnumFlatMode(30, "FLAT_MODE_VIDEO_LIGHT_PAINTING")
...
internal sealed class EnumPresetGroupIcon(override val value: Int, override val name: String? = null) : pbandk.Message.Enum {
    ...
    internal object PRESET_GROUP_TIMELAPSE_ICON_ID : EnumPresetGroupIcon(2, "PRESET_GROUP_TIMELAPSE_ICON_ID")
    internal object PRESET_GROUP_LONG_BAT_VIDEO_ICON_ID : EnumPresetGroupIcon(3, "PRESET_GROUP_LONG_BAT_VIDEO_ICON_ID")
    internal object PRESET_GROUP_ENDURANCE_VIDEO_ICON_ID : EnumPresetGroupIcon(4, "PRESET_GROUP_ENDURANCE_VIDEO_ICON_ID")
    internal object PRESET_GROUP_MAX_VIDEO_ICON_ID : EnumPresetGroupIcon(5, "PRESET_GROUP_MAX_VIDEO_ICON_ID")
    internal object PRESET_GROUP_MAX_PHOTO_ICON_ID : EnumPresetGroupIcon(6, "PRESET_GROUP_MAX_PHOTO_ICON_ID")
    internal object PRESET_GROUP_MAX_TIMELAPSE_ICON_ID : EnumPresetGroupIcon(7, "PRESET_GROUP_MAX_TIMELAPSE_ICON_ID")
    internal object PRESET_GROUP_ND_MOD_VIDEO_ICON_ID : EnumPresetGroupIcon(8, "PRESET_GROUP_ND_MOD_VIDEO_ICON_ID")
    internal object PRESET_GROUP_ND_MOD_PHOTO_ICON_ID : EnumPresetGroupIcon(9, "PRESET_GROUP_ND_MOD_PHOTO_ICON_ID")
...
internal sealed class EnumPresetIcon(override val value: Int, override val name: String? = null) : pbandk.Message.Enum {
    ...
    internal object PRESET_ICON_STANDARD_ENDURANCE : EnumPresetIcon(60, "PRESET_ICON_STANDARD_ENDURANCE")
    internal object PRESET_ICON_ACTIVITY_ENDURANCE : EnumPresetIcon(61, "PRESET_ICON_ACTIVITY_ENDURANCE")
    internal object PRESET_ICON_CINEMATIC_ENDURANCE : EnumPresetIcon(62, "PRESET_ICON_CINEMATIC_ENDURANCE")
    ...
    internal object PRESET_ICON_SIMPLE_SUPER_PHOTO : EnumPresetIcon(70, "PRESET_ICON_SIMPLE_SUPER_PHOTO")
    internal object PRESET_ICON_SIMPLE_NIGHT_PHOTO : EnumPresetIcon(71, "PRESET_ICON_SIMPLE_NIGHT_PHOTO")
    internal object PRESET_ICON_HIGHEST_QUALITY_VIDEO : EnumPresetIcon(73, "PRESET_ICON_HIGHEST_QUALITY_VIDEO")
    internal object PRESET_ICON_STANDARD_QUALITY_VIDEO : EnumPresetIcon(74, "PRESET_ICON_STANDARD_QUALITY_VIDEO")
    internal object PRESET_ICON_BASIC_QUALITY_VIDEO : EnumPresetIcon(75, "PRESET_ICON_BASIC_QUALITY_VIDEO")
    ...
    internal object PRESET_ICON_EASY_MAX_TIMEWARP : EnumPresetIcon(82, "PRESET_ICON_EASY_MAX_TIMEWARP")
    internal object PRESET_ICON_EASY_MAX_STAR_TRAIL : EnumPresetIcon(83, "PRESET_ICON_EASY_MAX_STAR_TRAIL")
    internal object PRESET_ICON_EASY_MAX_LIGHT_PAINTING : EnumPresetIcon(84, "PRESET_ICON_EASY_MAX_LIGHT_PAINTING")
    internal object PRESET_ICON_EASY_MAX_LIGHT_TRAIL : EnumPresetIcon(85, "PRESET_ICON_EASY_MAX_LIGHT_TRAIL")
    internal object PRESET_ICON_MAX_STAR_TRAIL : EnumPresetIcon(89, "PRESET_ICON_MAX_STAR_TRAIL")
    internal object PRESET_ICON_MAX_LIGHT_PAINTING : EnumPresetIcon(90, "PRESET_ICON_MAX_LIGHT_PAINTING")
    internal object PRESET_ICON_MAX_LIGHT_TRAIL : EnumPresetIcon(91, "PRESET_ICON_MAX_LIGHT_TRAIL")
    internal object PRESET_ICON_EASY_STANDARD_PROFILE : EnumPresetIcon(100, "PRESET_ICON_EASY_STANDARD_PROFILE")
    internal object PRESET_ICON_EASY_HDR_PROFILE : EnumPresetIcon(101, "PRESET_ICON_EASY_HDR_PROFILE")
...
internal sealed class EnumPresetTitle(override val value: Int, override val name: String? = null) : pbandk.Message.Enum {
    ...
    internal object PRESET_TITLE_CUSTOM_CINEMATIC : EnumPresetTitle(43, "PRESET_TITLE_CUSTOM_CINEMATIC")
    ...
    internal object PRESET_TITLE_STANDARD_ENDURANCE : EnumPresetTitle(60, "PRESET_TITLE_STANDARD_ENDURANCE")
    internal object PRESET_TITLE_ACTIVITY_ENDURANCE : EnumPresetTitle(61, "PRESET_TITLE_ACTIVITY_ENDURANCE")
    internal object PRESET_TITLE_CINEMATIC_ENDURANCE : EnumPresetTitle(62, "PRESET_TITLE_CINEMATIC_ENDURANCE")
    internal object PRESET_TITLE_SLOMO_ENDURANCE : EnumPresetTitle(63, "PRESET_TITLE_SLOMO_ENDURANCE")
    ...
    internal object PRESET_TITLE_SIMPLE_TIME_WARP : EnumPresetTitle(69, "PRESET_TITLE_SIMPLE_TIME_WARP")
    internal object PRESET_TITLE_SIMPLE_SUPER_PHOTO : EnumPresetTitle(70, "PRESET_TITLE_SIMPLE_SUPER_PHOTO")
    internal object PRESET_TITLE_SIMPLE_NIGHT_PHOTO : EnumPresetTitle(71, "PRESET_TITLE_SIMPLE_NIGHT_PHOTO")
    internal object PRESET_TITLE_SIMPLE_VIDEO_ENDURANCE : EnumPresetTitle(72, "PRESET_TITLE_SIMPLE_VIDEO_ENDURANCE")
    internal object PRESET_TITLE_HIGHEST_QUALITY : EnumPresetTitle(73, "PRESET_TITLE_HIGHEST_QUALITY")
    internal object PRESET_TITLE_EXTENDED_BATTERY : EnumPresetTitle(74, "PRESET_TITLE_EXTENDED_BATTERY")
    internal object PRESET_TITLE_LONGEST_BATTERY : EnumPresetTitle(75, "PRESET_TITLE_LONGEST_BATTERY")
    ...
    internal object PRESET_TITLE_STANDARD_QUALITY_VIDEO : EnumPresetTitle(82, "PRESET_TITLE_STANDARD_QUALITY_VIDEO")
    internal object PRESET_TITLE_BASIC_QUALITY_VIDEO : EnumPresetTitle(83, "PRESET_TITLE_BASIC_QUALITY_VIDEO")
    internal object PRESET_TITLE_HIGHEST_QUALITY_VIDEO : EnumPresetTitle(93, "PRESET_TITLE_HIGHEST_QUALITY_VIDEO")
    internal object PRESET_TITLE_USER_DEFINED_CUSTOM_NAME : EnumPresetTitle(94, "PRESET_TITLE_USER_DEFINED_CUSTOM_NAME")
    internal object PRESET_TITLE_EASY_STANDARD_PROFILE : EnumPresetTitle(99, "PRESET_TITLE_EASY_STANDARD_PROFILE")
    internal object PRESET_TITLE_EASY_HDR_PROFILE : EnumPresetTitle(100, "PRESET_TITLE_EASY_HDR_PROFILE")
