# ble_command_enable_analytics.py/Open GoPro, Version 1.0 (C) Copyright 2021 GoPro, Inc. (http://gopro.com/OpenGoPro).
# This copyright was auto-generated on Thu, May  6, 2021 11:38:45 AM
...
async def main():
    ...
    # Write to command request UUID to enable analytics
